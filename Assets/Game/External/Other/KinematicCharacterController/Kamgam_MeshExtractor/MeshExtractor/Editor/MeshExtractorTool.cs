...
namespace Kamgam.MeshExtractor
{
    ...
    partial class MeshExtractorTool : EditorTool
    {
        ...
        public override void OnToolGUI(EditorWindow window)
        {
            ...
            if (current.isKey && current.keyCode == MeshExtractorSettings.GetOrCreateSettings().TriggerSelectLinked && !Tools.viewToolActive)
            {
                keyEvent = true;
                useKey = true;
            }
        ...
        public void SetMode(Mode mode)
        {
            ...
            switch (mode)
            {
                ...
                case Mode.ExtractMesh:
                    ...
                    if (!_pivotModified && !_extractBoneWeights)
                    {
