...
namespace Kamgam.MeshExtractor
{
    ...
    /// Occlusion culling is a problem for objects with many triangles. It's not supported.<br />
    /// </summary>
    public static class TriangleCache
    {
        ...
        /// <returns></returns>
        public static List<SelectedTriangle> AddLinked(IList<GameObject> objects, SelectedTriangle selectedTri, bool limitToSubMesh, int maxDuration, bool showFailedPopup = true)
        {
